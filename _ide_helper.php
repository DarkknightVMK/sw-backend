 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function adminView($uri, $component, $data = [], $options = [])
        {
                        return \Illuminate\Routing\Router::adminView($uri, $component, $data, $options);
        }
                    /**
         * 
         *
...
')
     ...
     */ 
        ...
        {
                        return \Encore\Admin\Admin::view($view, $data);
        }
                    /**
        ...
        public static function macro($name, $macro)
        {
                        \Encore\Admin\Admin::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Encore\Admin\Admin::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Encore\Admin\Admin::hasMacro($name);
        }
