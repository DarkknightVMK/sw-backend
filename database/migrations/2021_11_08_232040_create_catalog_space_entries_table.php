...
class CreateCatalogSpaceEntriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('catalog_space_entries', function (Blueprint $table) {
            $table->id();
            //int id
    ...
    {
        Schema::dropIfExists('catalog_space_entries');
    }
}
